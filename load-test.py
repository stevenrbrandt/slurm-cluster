...
def check_output(user):
    strs = [
        ...
        "All done !",
        "components checked out successfully.",
...
def create_user(user):
    ...
    pcall(["cp","-u","/etc/passwd","/home/passwd"])
    pcall(["cp","-u","/etc/shadow","/home/shadow"])
    pcall(["cp","-u","/etc/group","/home/group"])
    pcall(["rm","-fr",f"/home/{user}/Cactus"])
    pcall(["rm","-fr",f"/home/{user}/simulations"])
    pcall(["cp","/home/sbrandt/CactusTutorial.ipynb",f"/home/{user}/"])
